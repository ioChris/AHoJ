...
* `chains`: A single chain or multiple chains separated by commas (without whitespace), or “ALL” or “\*” in the case of all chains (i.e. “A” or “A,C,D” or “ALL” or “\*”). This argument is case-sensitive and it is obligatory if the user intends to provide any argument after that (i.e. ligands or position).
